...
function getPizza() {
  // get id of pizza
  // why do we need the "new" here? previously this means we can't run the .get until after establishing the new ""
  // is this related to nested functions for privacy? probably yes as well as the Constructor method/feature
